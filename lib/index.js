...
export class VFileMessage extends Error {
   ...
   *
   * @overload
   * @param {Error | VFileMessage | string} reason
   * @param {Node | NodeLike | Point | Position | null | undefined} [place]
   ...
   * @param {Node | NodeLike | Point | Position | string | null | undefined} [place]
